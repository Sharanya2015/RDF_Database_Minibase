...
/**
 * Base class for a label index file
 */
public abstract class LabelIndexFile {
   ...
   * @param lid  the lid of the label with the key
   * @exception IOException             from lower layers
   * @exception KeyTooLongException     the key is too long
   * @exception KeyNotMatchException    the keys do not match
   * @exception LeafInsertRecException  insert label to leaf page failed
   * @exception IndexInsertRecException insert label to index page failed
   ...
   * @exception DeleteRecException      delete label failed
   ...
   * @exception InsertException         insert label failed
   */
  ...
  /**
   * Delete entry from the label index file.
   * 
   * @param data the key for the entry
   * @param lid  the lid of the label with the key
   * @exception IOException               from lower layers
   ...
   * @exception InsertRecException        insert label failed
   * @exception KeyNotMatchException      keys do not match
   * @exception UnpinPageException        unpin page failed
   * @exception IndexInsertRecException   insert label to index failed
