/*
 * @(#) QuadrupleBT.java   
 * This class is derived from BT.java 98/05/14
 ...
 * key and data abstraction. The QuadrupleBTLeafPage and QuadrupleBTIndexPage
 * code
 ...
 *
 * Furthermore, the QuadrupleBT<*>Page classes need
 ...
 * or the whole QuadrupleB+ tree structure or all leaf pages.
 *
 */
public class QuadrupleBT implements GlobalConst {
  ...
  /**
   * used for debug: to print a page out. The page is either QuadrupleBTIndexPage,
   * or QuadrupleBTLeafPage.
   * 
   ...
   * @exception ConstructPageException      error for QuadrupleBT page constructor
  ...
  public static void printPage(PageId pageno, int keyType)
    ...
    if (sortedPage.getType() == NodeType.INDEX) {
      ...
      for (KeyDataEntry entry = indexPage.getFirst(qid); entry != null; entry = indexPage.getNext(qid)) {
        if (keyType == AttrType.attrInteger)
      ...
      for (KeyDataEntry entry = leafPage.getFirst(qid); entry != null; entry = leafPage.getNext(qid)) {
        if (keyType == AttrType.attrInteger)
  ...
  /**
   * For debug. Print the Quadruple B+ tree structure out
   * 
   * @param header the head page of the Quadruple B+ tree file
   * @exception IOException                 error from the lower layer
   * @exception ConstructPageException      error from QuadrupleBT page
   *                                        constructor
  ...
  /**
   * For debug. Print all leaf pages of the Quadruple B+ tree out
   * 
   * @param header the head page of the Quadruple B+ tree file
   * @exception IOException                 error from the lower layer
   * @exception ConstructPageException      error for QuadrupleBT page constructor
