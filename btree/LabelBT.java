...
// This file is similar to BT.java 
/**
 * This file contains, among some debug utilities, the interface to our
 * key and data abstraction. The LabelBTLeafPage and LabelBTIndexPage code
 ...
 *
 * Furthermore, the labelBT<*>Page classes need
...
public class LabelBT implements GlobalConst {
  ...
  /**
   * used for debug: to print a page out. The page is either LabelBTIndexPage,
   * or LabelBTLeafPage.
   * 
   ...
   * @exception ConstructPageException      error for LabelBT page constructor
  ...
  public static void printPage(PageId pageno, int keyType)
    ...
    if (sortedPage.getType() == NodeType.INDEX) {
      ...
      for (KeyDataEntry entry = indexPage.getFirst(lid); entry != null; entry = indexPage.getNext(lid)) {
        if (keyType == AttrType.attrInteger)
      ...
      for (KeyDataEntry entry = leafPage.getFirst(lid); entry != null; entry = leafPage.getNext(lid)) {
        if (keyType == AttrType.attrInteger)
   ...
   * @exception IOException                 error from the lower layer
   * @exception ConstructPageException      error from labelBT page constructor
